...
//        .toLocalTime();
    ...
    public static List<UserMealWithExceed> getWithExceeded(Collection<UserMeal> userMeals, int caloriesPerDay){
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(Collection<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return mealList.stream()
                ...
                .map(um-> createWithExceeded(um, caloriesSumByDay.get(um.getDateTime().toLocalDate())>caloriesPerDay))
